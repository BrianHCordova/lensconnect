...
const SignInModal = () => {
  ...
  return (
    <>
      ...
      {showModal && (
        <div className="fixed inset-0 z-[50] grid h-screen w-screen place-items-center bg-black bg-opacity-60 opacity-0 backdrop-blur-sm transition-opacity duration-300">
          <div
